                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ChapterCard(
                        name: "Freedom Time",
                        chapterNumber: 1,
                        tag: "Baby's crying wormed",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Slavery Time",
                        chapterNumber: 2,
                        tag: "Violence is overt",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "The Ravagging",
                        chapterNumber: 3,
                        tag: "Through her thoughtlessness",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Promise",
                        chapterNumber: 4,
                        tag: "Community are not truly free",
                        press: () {},
                      ),
                      ChapterCard(
                        name: "Exodus",
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            "A dazzling debut novel that sweeps across eras and generations to tell the story of a mother and daughter with a shared talent for healing.",
                            maxLines: 5,
                            style: TextStyle(
                              fontSize: 10,
